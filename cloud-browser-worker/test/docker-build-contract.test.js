...
test('v105 worker image and systemd deployment fail closed and preserve durable queue state', async () => {
  ...
  assert.match(dockerfile, /org\.opencontainers\.image\.version="v105"/)
