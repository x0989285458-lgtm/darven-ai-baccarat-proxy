...
test('formal backlog delivery uses the measured three-second cadence with bounded payload and request limits', async () => {
  const server = await readFile(new URL('../src/server.js', import.meta.url), 'utf8')
  assert.match(server, /PUSH_INTERVAL_MS\s*\?\?\s*3000/)
