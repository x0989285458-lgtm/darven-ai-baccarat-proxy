...
test('worker admin key is backward compatible outside validated production when unset', () => {
...
test('worker admin key accepts only the header by default', () => {
...
test('worker control actions require header token and do not accept query token', () => {
