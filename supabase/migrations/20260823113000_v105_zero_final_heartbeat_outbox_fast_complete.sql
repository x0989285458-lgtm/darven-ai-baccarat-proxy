-- V105 zero-Final heartbeats must keep durable sequence/idempotency evidence without creating settlement work.
-- Additive replacement only: no historical data is dropped or rewritten.
