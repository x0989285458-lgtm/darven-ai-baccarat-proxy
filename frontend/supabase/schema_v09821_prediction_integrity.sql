-- v098.21: durable pre-result prediction identity and immutable issuance payload.
-- Additive only. Apply separately with service/admin privileges; this file is not auto-executed.
