...
test('total manager can suspend extend and delete a license, non-total manager is rejected', async () => {
  const queries = []
...
test('server exposes backend-only license operation endpoints', async () => {
  const calls = []
