...
const rows = [
  {
    ...
    strategy_version: 'v097_副預測命中校準與門檻降5版',
...
test('v098 stable report excludes rows missing immutable identity or complete saved side actions', () => {
...
test('v098 stable report excludes every saved row for a contradictory settlement key', () => {
