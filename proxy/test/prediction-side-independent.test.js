...
test('side predictions use independent 31-key weight profiles per target, not one merged side profile', () => {
...
test('side action-rate targets are independent and match requested per-100 rates', () => {
...
test('prediction row persists per-target side weights and tuning metadata', () => {
