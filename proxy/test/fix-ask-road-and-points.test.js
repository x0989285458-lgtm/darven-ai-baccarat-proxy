...
test('five-road ask-road compares road content instead of equal payload length', () => {
...
test('snapshot-delta inferred rows reuse exact show_poker result points when available', () => {
  const emitted = []
