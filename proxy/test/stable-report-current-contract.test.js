...
test('main hit-rate excludes tie rounds from denominator', () => {
...
test('low-confidence main predictions stay visible and are still evaluated without observe', () => {
...
test('confidence is clamped between 30 and 70', () => {
  const session = createStableReportSession({ startedAt: '2026-01-01T00:00:00.000Z' })
