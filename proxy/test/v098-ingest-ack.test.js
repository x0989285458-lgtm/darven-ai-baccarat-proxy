...
test('v098 ingest ACK follows durable writes and exactly echoes validated round keys', async () => {
  const order = []
  ...
  const envelope = { protocolVersion: 'v100', timestamp: 1_000_000, sequence: 7, roundKeys: ['BAG01:88:21'], snapshot: {
    buildVersion: '100', sessionId: 'worker-session', connected: true, authenticated: true,
