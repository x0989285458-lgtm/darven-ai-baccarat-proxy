...
test('current proxy advances to 1.0.66 while the unchanged frontend and worker retain their versions', async () => {
  assert.equal(readJson('../package.json').version, '1.0.66')
