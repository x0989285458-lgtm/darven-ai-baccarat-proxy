...
test('v076 side weights keep tie useful but shrink superSix pair and dragon noise', () => {
  ...
  assert.equal(SIDE_PREDICTION_WEIGHT_PROFILES.tie.tie_risk, 0.05)
  ...
  assert.equal(SIDE_PREDICTION_WEIGHT_PROFILES.superSix.table_side_history, 0.25)
  assert.equal(SIDE_PREDICTION_WEIGHT_PROFILES.superSix.banker_point, 0.65)
