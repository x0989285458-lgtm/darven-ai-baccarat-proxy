...
test('main weights rebalance away from over-player bias while keeping required features', () => {
...
test('prediction row records new Chinese version and thresholds remain active', () => {
