...
const addedMainKeys = ['roadmap_trend_signals', 'ask_road_signals']
...
test('main prediction removes unstable identity fields and gives real weight to requested signals', () => {
...
test('side prediction thresholds match the formal gates', () => {
...
test('side prediction removes weak correlation fields and uses A-K remaining ranks per target', () => {
...
test('prediction row records new strategy and preserves requested prediction outputs only', () => {
