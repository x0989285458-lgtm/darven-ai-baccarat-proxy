...
const approvedStrategyVersion = 'v104'
...
test('side prediction weights use exactly the approved existing factors', () => {
...
test('side prediction thresholds match the approved lowered gates', () => {
  assert.deepEqual(SIDE_PREDICTION_THRESHOLDS, approvedThresholds)
})

test('side prediction boundary gates require scores to reach the threshold', () => {
