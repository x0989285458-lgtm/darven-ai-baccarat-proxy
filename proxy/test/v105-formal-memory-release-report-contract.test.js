...
test('formal release E2E report is compact and idempotent by release day', async () => {
  ...
  const input = {
    releaseVersion: 'v105.0.0-formal.12', strategyVersion: 'v105', completedAt: '2026-07-24T16:30:00.000Z',
  ...
  assert.equal(writes[0].body.raw_summary.releaseVersion, 'v105.0.0-formal.12')
