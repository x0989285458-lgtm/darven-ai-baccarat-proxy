...
test('super six is actionable only when the main prediction is banker', () => {
...
test('dragon bonus predictions are actionable only for matching main side and separated scores', () => {
...
test('pair and tie actuals use exact rank equality and final settlement points', () => {
