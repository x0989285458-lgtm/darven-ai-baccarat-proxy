...
test('decorates visible round with its exact durable issuance while pre-issuing the future round', async () => {
...
test('local non-durable mode exposes only an exact screen-round prediction', async () => {
