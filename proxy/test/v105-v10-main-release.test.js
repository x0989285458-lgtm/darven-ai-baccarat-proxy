...
test('V105 V10 main release changes prediction main only', () => {
  assert.equal(manifest.releaseVersion, 'v105-v10-main.4')
...
test('V105 V10 main release binding covers the exact prediction implementation', () => {
  ...
  for (const required of ['proxy/src/cloud-capture.js', 'proxy/src/server.js', 'proxy/src/v105-formal-runtime.js', 'proxy/src/v105-v10-main-strategy.js', 'proxy/src/v105-shadow-v10-contract.js', 'proxy/src/v105-shadow-v10-structure.js', 'frontend/src/lib/onlineLicenseClient.ts']) {
