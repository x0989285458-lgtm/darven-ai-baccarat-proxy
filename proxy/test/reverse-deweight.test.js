...
test('detects three straight wrong predictions and applies reverse correction without observe', () => {
...
test('caps very low hit-rate tables faster even before the long window fills', () => {
...
test('stable report exposes reverse/deweight status and version 023', () => {
