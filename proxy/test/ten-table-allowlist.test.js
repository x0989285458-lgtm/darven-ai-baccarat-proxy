...
test('canonicalizes proxy table and round aliases before filtering and dedupe', () => {
...
test('proxy keeps only the approved ten tables and rounds in the approved order', () => {
