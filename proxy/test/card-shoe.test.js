...
test('parses each baccarat card into code rank face and baccarat point', () => {
...
test('dragon bonus actual counts natural no-draw direct win even when point diff is below 4', () => {
...
test('tracks remaining A-K ranks and 0-9 baccarat points per table shoe', () => {
...
test('scores card and shoe features for main and side prediction weighting', () => {
  const tracker = createShoeTracker({ deckCount: 8 })
