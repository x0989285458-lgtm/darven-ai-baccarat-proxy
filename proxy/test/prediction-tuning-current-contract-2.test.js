...
test('side weights keep tie useful but shrink superSix pair and dragon noise', () => {
  ...
  assert.equal(SIDE_PREDICTION_WEIGHT_PROFILES.superSix.table_side_history, 0.35)
  assert.equal(SIDE_PREDICTION_WEIGHT_PROFILES.superSix.banker_point, 0.35)
...
test('prediction row records new strategy without changing main action-rate target shape', () => {
