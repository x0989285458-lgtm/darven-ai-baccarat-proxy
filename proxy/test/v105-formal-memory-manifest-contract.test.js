...
test('formal.12 manifest activates memory only after live E2E with the exact formal parameters', () => {
  assert.equal(manifest.releaseVersion, 'v105.0.0-formal.12')
  assert.equal(V105_FORMAL_RELEASE_VERSION, 'v105.0.0-formal.12')
