...
test('preflight requires connected authenticated chrome capture and at least 9 tables', () => {
...
test('records first 9 visible tables, hit rate, partial report, and ignores duplicate rounds', () => {
  const session = createStableReportSession({ targetTableCount: 9, startedAt: '2026-06-27T00:00:00.000Z' })
...
test('parses minutes/seconds duration and formats a Traditional Chinese report', () => {
  ...
  assert.match(text, /瑞文AI百家策略調整成效統計與AB追蹤報表/)
