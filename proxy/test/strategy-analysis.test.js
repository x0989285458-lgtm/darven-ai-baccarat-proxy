...
test('compares strategy versions and marks best baseline by main hit rate', () => {
...
test('extracts weak and strong tables from raw report summaries for next strategy advice', () => {
  const analysis = buildStrategyAnalysis([
