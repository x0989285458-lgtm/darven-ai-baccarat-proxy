...
test('ui-history uses bearer auth, canonical live-table allowlist, and authoritative shoe', async () => {
  const calls = []
...
test('ui-history fails closed with 503 when either DB getter is unavailable or fails', async () => {
