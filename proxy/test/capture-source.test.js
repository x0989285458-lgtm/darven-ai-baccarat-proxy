...
test('status distinguishes node websocket, local chrome, and future cloud browser capture sources', () => {
...
test('keeps one normalized snapshot interface for chrome frames and future cloud ingestion', () => {
...
test('chooses chrome capture before node token direct when chrome url is available', () => {
