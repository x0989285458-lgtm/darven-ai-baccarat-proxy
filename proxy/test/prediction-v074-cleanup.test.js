...
test('v074 uses Chinese version name and preserves action-rate thresholds', () => {
  assert.equal(ALL_MT_EQUAL_STRATEGY_VERSION, 'v074_同出手率權重清理版')
