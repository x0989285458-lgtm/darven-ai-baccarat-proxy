...
test('builds browser-like MT websocket headers matching successful Chrome connection', () => {
...
test('waits for authenticate err 0 before requesting member and tables', () => {
...
test('extracts real MT tables from msg.tables payload shape', () => {
