...
test('banker/player dragon side actions are enabled and gated by matching main prediction', () => {
...
test('side prediction features include A-K remaining-card counts for every target', () => {
  const round = {
  ...
  const row = buildPredictionResultRow(round, { tableId: 'BAG05', shoe: 15396, round: 0, beadPlateRaw: '0202', bankerCount: 1, playerCount: 0, tieCount: 0, cardShoe: round.cardShoe })
