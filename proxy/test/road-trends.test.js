...
test('detects requested expanded baccarat road trends', () => {
...
test('expanded road trends affect main recentTrend source score', () => {
...
test('report and package version labels are updated', () => {
