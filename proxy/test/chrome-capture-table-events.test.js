...
test('extracts table-specific summary result after entering a baccarat table', () => {
...
test('keeps table data fresh from table-specific frames even when /tables frames stop', () => {
