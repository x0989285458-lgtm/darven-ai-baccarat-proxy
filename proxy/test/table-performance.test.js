...
test('table performance tracker keeps banker/player prediction but lowers confidence for weak tables', () => {
...
test('stable report continuously verifies each table hit rate while still outputting banker/player prediction', () => {
