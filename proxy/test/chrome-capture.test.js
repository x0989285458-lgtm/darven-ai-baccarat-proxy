...
test('extracts MT tables from Chrome DevTools websocket frame payload', () => {
...
test('recognizes tables payload by action name and msg.tables', () => {
...
test('launches Chrome with remote debugging and isolated profile', () => {
